#' `sce_tmfacs` is a `SingleCellExperiment` object of `marrow` datasets from The Tabula Muris Consortium.
#'
...
#' @docType data
#'
#' @usage data(sce_tmfacs)
#'
#' @format `SingleCellExperiment` object for the `marrow` dataset
#'
#' @keywords datasets
#'
